                                ...
                                if (workspacesModel.count !== newData.length) {
                                    ...
                                    for (let i = 0; i < newData.length; i++) {
                                        workspacesModel.append({
                                            ...
                                            "wsLabel": (newData[i].label || (i + 1)).toString(),
                                    ...
                                    for (let i = 0; i < newData.length; i++) {
                                        ...
                                        let lbl = (newData[i].label || (i + 1)).toString();
                                        if (workspacesModel.get(i).wsLabel !== lbl)
                                            workspacesModel.setProperty(i, "wsLabel", lbl);
                                    }
                                }
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.95) : Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.82)
                        radius: barWindow.s(14); border.width: 1; border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, isHovered ? 0.22 : 0.11)
                    ...
                    Rectangle {
                        color: Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.82)
                        radius: barWindow.s(14); border.width: 1; border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.11)
                        Layout.preferredHeight: parent.moduleHeight
                        clip: true
                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    property string wsLabel: model.wsLabel || model.wsId
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.13)
                        border.width: 1
                        color: Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.82)
